...
4. Under **RAG Storage and Retrieval**, set your **Embedding Source**. Perplexity is recommended — OpenAI and Qwen are stronger embedding models but can slow significantly during peak periods, adding up to 30 seconds per turn.

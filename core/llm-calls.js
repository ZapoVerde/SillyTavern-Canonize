 ...
 * @param {string} [existingThreads]  Formatted "Currently running plots:" block with arc entries.
 * @returns {Promise<string>}
 */
export function runHookseekerCall(transcript, prevScene = '', existingThreads = '') {
